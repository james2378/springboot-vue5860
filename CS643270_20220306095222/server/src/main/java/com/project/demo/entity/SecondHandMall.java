...
/**
 *二手商城：(SecondHandMall)表实体类
 *
 */
@Setter
@Getter
@Entity(name = "SecondHandMall")
public class SecondHandMall implements Serializable {

    //SecondHandMall编号
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "second_hand_mall_id")
    private Integer second_hand_mall_id;
   // 卖家
   @Basic
